...
`React.useDebugValue` is used essentially to label custom hooks in the react dev
tools chrome extension. Its second argument is only useful is calculating the
debug value is somehow expensive and we need to optimize it
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=Advanced%20React%20Hooks%20%F0%9F%94%A5&e=06%3A%20useDebugValue%3A%20useMedia&em=yoh.legrand%40gmail.com).
